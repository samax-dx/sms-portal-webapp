...
const WriteForm = ({ record, onRecordSaved,groupId,close }) => {
    const { Option } = Select;
...
export const AllContact = () => {
    ...
    return (<>
        <Row >
            ...
            <Modal key="createGroup" visible={modalData} footer={null} onCancel={handleCancel} maskClosable={false} closable={false} style={{ top: 20 }} bodyStyle={{height:"19rem"}}>
